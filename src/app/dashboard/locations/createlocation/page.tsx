 ...
 /*   const log = () => {
    ...
    return <div  className="create-location"  >
        ...
        <div className="create-location-title" >
            ...
            <input placeholder="County"   onChange={(e)=>{setCounty(e.target.value)}}          />
        </div>
        ...
        <form className="upload-picture">
            ...
            <input  placeholder="Individuals employed?"  onChange={(e)=>{setIndividuls(e.target.value)}} />
        ...
        <div  className="create-location-button" >
         ...
         <button onClick={()=>{setPopup(true)}} >Create Location</button>
        </div>
