...
const usePost = () => {
       ...
       async function POST(title:string,tag:string,content:string) {
           ...
           try{
            ...
            const res = await fetch("http://localhost:3000/api/stories", {
               ...
               body: JSON.stringify({ method:"POST",title:title,tag:tag,content:content }),
             })
        ...
        async function EditStory(title: string,tag:string, content:string, id:string) {
         ...
         const res = await fetch("http://localhost:3000/api/stories", {
          ...
          body: JSON.stringify({ method:"PUT",title:title,tag:tag,content:content,id:id }),
        })
    ...
    return  {POST,EditStory,deleteStory,getOneStoryData, popup,setPopup, createStory, setCreateStory,isLoading, setIsLoading ,error,  setError}
  }
